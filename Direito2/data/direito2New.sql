...
-- Table `mydb`.`tb_fonte`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_fonte` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_noticia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_noticia_hash` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_fornecedor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_sessao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_noticia_update` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_noticia_fullsearch` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_noticia_mssql` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_comentario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_comentario_palavras` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_noticia_visualizacoes` ;
...
-- Table `mydb`.`tb_mes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_mes` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_newsletter` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_pessoa_newsletter` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_newsletter_fonte` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_newsletter_mensagem` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_newsletter_mensagem_noticia` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_newsletter_mensagem_pessoa` ;
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_palavra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_palavra` ;

CREATE  TABLE IF NOT EXISTS `mydb`.`tb_palavra` (
  `cd_palavra` INT NOT NULL AUTO_INCREMENT ,
  `cd_palavra_correta` INT NULL ,
  `nm_palavra` VARCHAR(100) NOT NULL ,
  `dt_inclusao` VARCHAR(45) NULL DEFAULT 'CURRENT_TIMESTAMP' ,
  `qt_noticia` INT NULL DEFAULT 0 ,
  PRIMARY KEY (`cd_palavra`) ,
  FULLTEXT INDEX `tb_palavra_nm_palavra` (`nm_palavra` ASC) ,
  INDEX `tb_palavra_cd_palavra` (`cd_palavra_correta` ASC) ,
  CONSTRAINT `tb_palavra_cd_palavra`
    FOREIGN KEY (`cd_palavra_correta` )
    REFERENCES `mydb`.`tb_palavra` (`cd_palavra` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = MyISAM, 
COMMENT = 'Palavras' ;
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_palavra_noticia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tb_palavra_noticia` ;

CREATE  TABLE IF NOT EXISTS `mydb`.`tb_palavra_noticia` (
  ...
  INDEX `ix_palavra_noticia_cd_palavra` (`cd_palavra` ASC) ,
