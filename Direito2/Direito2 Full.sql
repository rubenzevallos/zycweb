...
-- Table `mydb`.`tb_fonte`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_fonte` (
  ...
  `ds_icone` VARCHAR(100) NULL COMMENT 'Icone ou logo da fonte' ,
  ...
  `ds_merlim` TEXT NULL COMMENT 'JSON dos parâmetros para o Merlim' ,
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_noticia`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_noticia` (
  `cd_noticia` INT NOT NULL AUTO_INCREMENT COMMENT 'PK Noticia' ,
  `cd_fonte` INT NULL COMMENT 'FK da Fonte da noticia' ,
  `nm_noticia` VARCHAR(500) NOT NULL COMMENT 'Título da notícia' ,
  `ds_resumo` TEXT NULL COMMENT 'Resumo para listagens' ,
  `ds_noticia` TEXT NULL COMMENT 'Conteúdo da notícia' ,
  `dt_inclusao` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data e hora da inclusão' ,
  `dt_referencia` DATETIME NULL COMMENT 'Data e hora de referência da publicação real da notícia, caso não seja a data de inclusão' ,
  `fl_ativo` TINYINT NULL DEFAULT 1 COMMENT 'Se a notícia está ativa' ,
  `dt_inclusao_year` SMALLINT NULL COMMENT 'Ano da Inclusão - Para fins de indexação' ,
  `dt_inclusao_month` TINYINT NULL COMMENT 'Mes da Inclusão - Para fins de indexação' ,
  `dt_inclusao_day` TINYINT NULL COMMENT 'Dia da Inclusão - Para fins de indexação' ,
  `dt_referencia_year` SMALLINT NULL COMMENT 'Ano da data de referêcia- Para fins de indexação' ,
  `dt_referencia_month` TINYINT NULL COMMENT 'Mes da data de referêcia- Para fins de indexação' ,
  `dt_referencia_day` TINYINT NULL COMMENT 'Dia da data de referêcia- Para fins de indexação' ,
  `qt_visualizacao` INT NULL DEFAULT 0 COMMENT 'Quantidade total de vezes que foi visualizada' ,
  `dt_visualizacao` DATETIME NULL COMMENT 'Data e hora da última visualização' ,
  ...
  CONSTRAINT `tb_noticia_cd_fonte`
    ...
    REFERENCES `mydb`.`tb_fonte` (`cd_fonte` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Noticias ' ;
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_noticia_hash`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_noticia_hash` (
  ...
  `ds_url` VARCHAR(255) NULL COMMENT 'URL a que o Hash se refere' ,
  `dt_inclusao` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data e hora da inclusão' ,
  ...
  CONSTRAINT `tb_noticia_hash_cd_noticia`
    ...
    REFERENCES `mydb`.`tb_noticia` (`cd_noticia` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB, 
COMMENT = 'Tabela de URLs e Hash das noticias. Uma noticia poderá ter ' /* comment truncated */ ;
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_sessao`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_sessao` (
  `cd_sessao` INT NOT NULL AUTO_INCREMENT COMMENT 'PK da sessão do envio de noticias' ,
  `ds_sessao` VARCHAR(45) NULL COMMENT 'Descrição da sessão usando JSON como Browser entre outras coisas' ,
  `dt_inclusao` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data e hora do início da sessão' ,
  `cd_fornecedor` INT NULL COMMENT 'Id do fornecedor, caso tenha sido ele que abriu a sessão' ,
  `ds_ip4` VARCHAR(15) NULL COMMENT 'IP da sessao' ,
  `nu_ip4_1` TINYINT NULL ,
  `nu_ip4_2` TINYINT NULL ,
  `nu_ip4_3` TINYINT NULL ,
  `nu_ip4_4` TINYINT NULL ,
  ...
  CONSTRAINT `tb_sessao_cd_fornecedor`
    ...
    REFERENCES `mydb`.`tb_fornecedor` (`cd_fornecedor` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB, 
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_noticia_update`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_noticia_update` (
  `cd_noticia_update` INT NOT NULL AUTO_INCREMENT COMMENT 'PK do Update' ,
  `cd_noticia` INT NULL COMMENT 'FK da notícia a que se refere' ,
  `cd_sessao` INT NULL COMMENT 'Sessão que foi usada' ,
  ...
  CONSTRAINT `tb_noticia_update_cd_sessao`
    ...
    REFERENCES `mydb`.`tb_sessao` (`cd_sessao` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB, 
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_noticia_fullsearch`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_noticia_fullsearch` (
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_noticia_mssql`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_noticia_mssql` (
  `cd_noticia` INT NOT NULL COMMENT 'PK da notícia' ,
  `cd_mssql` INT NULL COMMENT 'Id no MSSQL' ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_usuario` (
  ...
  `ds_senha` VARCHAR(20) NULL COMMENT 'Senha caso ele digite' ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_comentario` (
  ...
  `cd_comentario_pai` INT NULL COMMENT 'Comentário a quem este se refere' ,
  `cd_noticia` INT NOT NULL COMMENT 'FK da noticia que foi comentada' ,
  `cd_sessao` INT NULL COMMENT 'FK da sessão que gerou o comentário' ,
  `cd_usuario` INT NULL COMMENT 'Usuário que está incluindo o comentário. Ele será criado automaticamente, com senha gerada e enviada par ao usuário.' ,
  `ds_url` VARCHAR(100) NULL COMMENT 'URL que o usuário se refere' ,
  `ds_cidade` VARCHAR(100) NULL COMMENT 'Cidade do usuário' ,
  `ds_estado` VARCHAR(2) NULL COMMENT 'Estado do usuário' ,
  `ds_atividade` VARCHAR(100) NULL COMMENT 'Atividade que ele desenvolve' ,
  `ds_comentario` TEXT NULL COMMENT 'O comentário' ,
  `fl_notificar` TINYINT NULL COMMENT 'Se ele receberá notícias de atualização dos comentários' ,
  `dt_validado` DATETIME NULL COMMENT 'Data em que o comentário foi validado' ,
  `dt_inclusao` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data e hora da inclusão' ,
  `ds_ip4` VARCHAR(15) NULL COMMENT 'IP do envio do comentario, apesar que já está na sessão' ,
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_comentario_palavras`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_comentario_palavras` (
  `cd_comentario_palavras` INT NOT NULL COMMENT 'PK das palavras proibidas' ,
  `nm_comentario_palavras` VARCHAR(50) NULL COMMENT 'Palavra' ,
  `fl_frase` TINYINT NULL COMMENT '1 - Frase' ,
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_noticia_visualizacoes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_noticia_visualizacoes` (
  ...
  `nm_ano` SMALLINT NULL COMMENT 'Identificação do ano' ,
  `nm_mes` TINYINT NULL COMMENT 'Identificação do mês' ,
  `nm_dia` TINYINT NULL ,
  `nm_hora` TINYINT NULL ,
  `nm_quarter` TINYINT NULL ,
  `nm_day_of_year` SMALLINT NULL ,
  `nm_week` TINYINT NULL ,
  `nm_week_day` TINYINT NULL ,
...
-- Table `mydb`.`tb_mes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_mes` (
  `cd_mes` INT NOT NULL AUTO_INCREMENT ,
  `nm_mes` VARCHAR(20) NULL ,
  `sg_mes1` CHAR(1) NULL ,
  `sg_mes2` CHAR(2) NULL ,
  `sg_mes3` CHAR(3) NULL ,
  `nm_dias` TINYINT NULL ,
  `nm_bisexto` TINYINT NULL ,
  PRIMARY KEY (`cd_mes`) ,
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_newsletter`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_newsletter` (
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_pessoa_newsletter`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_pessoa_newsletter` (
  ...
  CONSTRAINT `tb_pessoa_newsletter_cd_pessoa`
    ...
    REFERENCES `mydb`.`tb_pessoa` (`cd_pessoa` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `tb_pessoa_newsletter_cd_newsletter`
    FOREIGN KEY (`cd_newsletter` )
    REFERENCES `mydb`.`tb_newsletter` (`cd_newsletter` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB, 
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_newsletter_fonte`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_newsletter_fonte` (
  `cd_newsletter_fonte` INT NOT NULL AUTO_INCREMENT ,
  `cd_newsletter` INT NOT NULL ,
  `cd_fonte` INT NOT NULL ,
  `fl_ativo` TINYINT NULL DEFAULT 1 ,
  `nu_ordem` TINYINT NULL COMMENT 'Ordem da fonte para a sua utilização' ,
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_newsletter_mensagem`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_newsletter_mensagem` (
  `cd_newsletter_mensagem` INT NOT NULL AUTO_INCREMENT ,
  `cd_newsletter` INT NOT NULL COMMENT 'Mensagem de qual newsletter' ,
  `dt_inclusao` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ,
  `qt_pessoas` INT NULL COMMENT 'Quantida de pessoas que receberão a mensagem' ,
  ...
  CONSTRAINT `tb_newsletter_mensagem_cd_newsletter`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB, 
COMMENT = 'Mensagens que foram geradas com base nos critérios da Newsl' /* comment truncated */ ;


-- -----------------------------------------------------
-- Table `mydb`.`tb_newsletter_mensagem_noticia`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_newsletter_mensagem_noticia` (
  `cd_newsletter_mensagem_noticia` INT NOT NULL AUTO_INCREMENT ,
  `cd_mensagem` INT NOT NULL ,
  `cd_noticia` INT NOT NULL ,
  `nu_ordem` TINYINT NULL COMMENT 'Ordem que será utilizada' ,
  ...
  CONSTRAINT `tb_newsletter_mensagem_noticia_cd_mensagem`
    ...
    REFERENCES `mydb`.`tb_newsletter_mensagem` (`cd_newsletter_mensagem` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB, 
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_newsletter_mensagem_pessoa`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`tb_newsletter_mensagem_pessoa` (
  ...
  `fl_estado` INT NULL ,
  `qt_tentativas` TINYINT NULL ,
  `dt_ultimo_estado` DATETIME NULL ,
