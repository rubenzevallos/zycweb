...
/* Estudar o uso de conexões persistentes pelo menos para o Cache
 * http://www.php.net/manual/en/features.persistent-connections.php
 * http://www.php.net/manual/en/function.register-shutdown-function.php
 */

$siteTitle 			 = 'Direito 2 | Notícias de Direito';
$siteURL         = Domain;
$siteDescription = 'O Direito 2 é o maior acervo de notícias de Direito do Brasil com mais de 700 mil notícias desde 1998, atualizado a cada 15 minutos.';
$siteLanguage    = 'pt-br';
...
if (gJS || gFeed) {
	...
	switch (parOption) {
		case 400: // listYear
			...
			$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a>';
			break;

		case 1: // listYear
			$doCache = 1;
			$titleH1 		 = 'Arquivo de Notícias';
			$title 			 = $titleH1.' | Direito 2';
			$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a>';
			break;
		...
		case 2: // listMonth
			$doCache = 1;
			$titleH1 		 = 'Notícias de '.gYear;
			$title 			 = $titleH1.' | Direito 2';
			$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a> » <a href="/noticias" title="Arquivo de notícias">Arquivo</a>';
			break;

			case 3: // listDay
			$doCache = 1;
			$titleH1 		 = 'Notícias de '.gMonth.' de '.gYear;
			$title 			 = $titleH1.' | Direito 2';
			$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a> » <a href="/noticias" title="Arquivo de notícias">Arquivo</a> » <a href="/noticias/'.gYear.'" title="Arquivo de notícia de '.gYear.'">'.gYear.'</a>';
			break;

		case 4: // listSource
			$doCache = 1;
			$titleH1 		 = 'Notícias de '.gDay.' de '.gMonth.' de '.gYear;
			$title 			 = $titleH1.' | Direito 2';
			$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a> » <a href="/noticias" title="Arquivo de notícias">Arquivo</a> » <a href="/noticias/'.gYear.'" title="Arquivo de notícia de '.gYear.'">'.gYear.'</a> » <a href="/noticias/'.gYear.'/'.gMonth.'">'.gMonth.'</a>';
			break;
		...
		case 5: // listNews
			...
			$title 			 = $titleH1.' | Direito 2';
			$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a> » <a href="/noticias" title="Arquivo de notícias">Arquivo</a> » <a href="/noticias/'.gYear.'" title="Arquivo de notícia de '.gYear.'">'.gYear.'</a> » <a href="/noticias/'.gYear.'/'.gMonth.'">'.gMonth.'</a> » <a href="/noticias/'.gYear.'/'.gMonth.'/'.gDay.'">'.gDay.'</a>';
			break;
		...
		case 6: // showNews
			...
			if ($snRow = mysql_fetch_object($showNews)) {
				...
				$title 			 = $titleH1.' | Direito 2';
				$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a> » <a href="/noticias" title="Arquivo de notícias">Arquivo</a> » <a href="/noticias/'.gYear.'" title="Arquivo de notícia de '.gYear.'">'.gYear.'</a> » <a href="/noticias/'.gYear.'/'.gMonth.'">'.gMonth.'</a> » <a href="/noticias/'.gYear.'/'.gMonth.'/'.gDay.'">'.gDay.'</a> » <a href="/'.gSource.'/'.gYear.'/'.gMonth.'/'.gDay.'">'.gSource.'</a>';
				$tipoFonte   = $snRow->tp_fonte;
				$fonteURL    = $snRow->ds_url_fonte;

				if (substr($fonteURL, -1) == '/') $fonteURL = substr($fonteURL, 0, -1);

				if ($snRow->nu_port) $fonteURL .= ":$snRow->nu_port";
		...
		case 8: // fontes
			...
			if ($lfRow = mysql_fetch_object($listaFonte)) {
				...
				$titleH1 		 = 'Erro 404 - Página não encontrada';
				$title 			 = $titleH1.' | Direito 2';
				$breadcrumbs = ' » <a href="/" title="Página inicial">Início</a>';
			}
		...
		switch (parOption) {
			case 400: // error
				echo '<div id="bloco" class="corpo content">
								<div id="areatexto">
									<h1>'.$titleH1.'</h1>
									<br />Endereço: http://'.$_SERVER[SERVER_NAME].$_SERVER[REQUEST_URI].'
									<br />Porta: '.$_SERVER[SERVER_PORT].'
									<br />Método: '.$_SERVER[REQUEST_METHOD].'
									<br />Endereço do servidor: '.$_SERVER[SERVER_ADDR].'
								</div>';
			...
			case 1: // listYear
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está na lista de anos das notícias publicadas" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 2: // listMonth
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está na lista dos meses das notícias publicadas" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 3: // listDay
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está na lista dos dias das notícias publicadas" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 4: // listSource
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está na lista das com as notícias publicadas" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 5: // listNews
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está na lista das notícias" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 6: // showNews
				echo '<div id="bloco" class="corpo content">';
					...
					if($snRow) {
						echo '<a title="Você está na notícia" accesskey="1" href="#conteudo" name="conteudo"></a>';

						require_once('d2ShowNews.inc.php');

					} else {
						echo '<h1>Página não encontrada</h1>
									<p><br />A página abaixo não foi encontrada no site. Pode ser que voce tenha escrito o endereço errado ou ela tenha sido excluida:
									<br />
									<br />'.$_SERVER[REQUEST_URI].'</p>';
			...
			case 7: // fullSearch
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está no resultado da busca por notícias" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 8: // listFontes
				...
				if ($lfError) {
					...
					echo '<div id="areatexto">
								<a title="Você está na lista das fontes das notícias publicadas" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 9: // listClima
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está na lista do clima" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			case 10: // listCotacoes
				echo '<div id="bloco" class="corpo content">';
					echo '<div id="areatexto">
								<a title="Você está na lista das cotações" accesskey="1" href="#conteudo" name="conteudo"></a>';
			...
			default:
				echo '<div id="bloco" class="corpo">
								<a title="Você está no início do conteúdo da página principal. Aqui voce terá vários blocos de notícias em destaque" accesskey="1" href="#conteudo" name="conteudo"></a>';
