...
define( 'YOURLS_DB_USER', 'zyc7' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'd2me432*' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'zyc7' );

/** MySQL hostname */
define( 'YOURLS_DB_HOST', 'mysql07.zyc.com.br' );
...
define( 'YOURLS_SITE', 'http://4d2.me' );
...
$yourls_reserved_URL = array(
	'porn', 'faggot', 'sex', 'nigger', 'fuck', 'cunt', 'dick', 'gay', 'buceta', 'caralho', 'merda', 'puta', 'pqp', 'fdp',
);
