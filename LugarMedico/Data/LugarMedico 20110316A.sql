...
ALTER TABLE `LugarMedico`.`TB_PESSOA` ADD COLUMN `DS_URL_PERFIL` VARCHAR(100) NULL DEFAULT NULL COMMENT 'Complemento da URL do Perfil público da pessoa'  AFTER `NM_ULTIMO` 
, DROP INDEX `DS_EMAIL` 
