...
CREATE INDEX `TB_PESSOA_DS_EMAIL` ON `TB_PESSOA` (`DS_EMAIL` ASC) ;

CREATE INDEX `TB_PESSOA_DS_NOME` ON `TB_PESSOA` (`NM_PESSOA` ASC) ;

CREATE INDEX `TB_PESSOA_CD_PREFIXO` ON `TB_PESSOA` (`CD_PREFIXO` ASC) ;

CREATE INDEX `TB_PESSOA_DS_URL_PERFIL` ON `TB_PESSOA` (`DS_URL_PERFIL` ASC) ;
...
CREATE INDEX `TB_USUARIO_CD_PESSOA` ON `TB_USUARIO` (`CD_PESSOA` ASC) ;

CREATE INDEX `DS_LOGIN` ON `TB_USUARIO` (`DS_LOGIN` ASC) ;
...
CREATE INDEX `TB_SESSAO_CD_PESSOA` ON `TB_SESSAO` (`CD_PESSOA` ASC) ;

CREATE INDEX `TB_SESSAO_CD_BROWSER` ON `TB_SESSAO` (`CD_BROWSER` ASC) ;

CREATE INDEX `TB_SESSAO_CD_DISPOSITIVO` ON `TB_SESSAO` (`CD_DISPOSITIVO` ASC) ;
...
CREATE INDEX `TB_PESSOA_FISICA_CD_PESSOA` ON `TB_PESSOA_FISICA` (`CD_PESSOA` ASC) ;

CREATE INDEX `NU_CPF` ON `TB_PESSOA_FISICA` (`NU_CPF` ASC) ;
...
CREATE INDEX `TB_PESSOA_JURIDICA_CD_PESSOA` ON `TB_PESSOA_JURIDICA` (`CD_PESSOA` ASC) ;
...
CREATE INDEX `TB_CIRCULO_CD_PESSOA` ON `TB_CIRCULO` (`CD_PESSOA` ASC) ;
...
CREATE INDEX `TB_CIRCULO_PESSOA_CD_CIRCULO` ON `TB_CIRCULO_PESSOA` (`CD_CIRCULO` ASC) ;

CREATE INDEX `TB_CIRCULO_PESSOA_CD_PESSOA` ON `TB_CIRCULO_PESSOA` (`CD_PESSOA` ASC) ;
...
CREATE INDEX `TB_COLEGA_CONVITE_CD_PESSOA` ON `TB_COLEGA_CONVITE` (`CD_PESSOA` ASC) ;
...
CREATE INDEX `TB_COMENTARIO_CD_PESSOA` ON `TB_COMENTARIO` (`CD_PESSOA` ASC) ;

CREATE INDEX `TB_COMENTARIO_CD_COMENTARIO_PAI` ON `TB_COMENTARIO` (`CD_COMENTARIO_PAI` ASC) ;

CREATE INDEX `TB_COMENTARIO_CD_PESSOA_ORIGINAL` ON `TB_COMENTARIO` (`CD_PESSOA_ORIGINAL` ASC) ;
...
CREATE INDEX `TB_OBJETO_CD_PESSOA` ON `TB_OBJETO` (`CD_PESSOA` ASC) ;
...
CREATE INDEX `TB_ALBUM_CD_PESSOA` ON `TB_ALBUM` (`CD_PESSOA` ASC) ;
...
CREATE INDEX `TB_ALBUM_OBJETO_CD_OBJETO` ON `TB_ALBUM_OBJETO` (`CD_OBJETO` ASC) ;

CREATE INDEX `TB_ALBUM_OBJETO_CD_ALBUM` ON `TB_ALBUM_OBJETO` (`CD_ALBUM` ASC) ;
...
CREATE INDEX `CD_COMENTARIOTB_COMENTARIO_ALBUM_OBJETO_` ON `TB_COMENTARIO_ALBUM_OBJETO` (`CD_COMENTARIO` ASC) ;

CREATE INDEX `CD_COMENTARIOTB_COMENTARIO_ALBUM_OBJETO_CD_ALBUM_OBJETO` ON `TB_COMENTARIO_ALBUM_OBJETO` (`CD_ALBUM_OBJETO` ASC) ;
...
CREATE INDEX `TB_PESSOA_CONTATO_CD_PESSOA` ON `TB_PESSOA_CONTATO` (`CD_PESSOA` ASC) ;
...
CREATE INDEX `DS_SIGLA` ON `TB_UF` (`DS_SIGLA` ASC) ;
...
CREATE INDEX `TB_CIDADE_CD_UF` ON `TB_CIDADE` (`CD_UF` ASC) ;
...
CREATE INDEX `TB_PESSOA_ENDERECO_CD_PESSOA` ON `TB_PESSOA_ENDERECO` (`CD_PESSOA` ASC) ;

CREATE INDEX `TB_PESSOA_ENDERECO_CD_LOGRADOURO` ON `TB_PESSOA_ENDERECO` (`CD_LOGRADOURO` ASC) ;

CREATE INDEX `TB_PESSOA_ENDERECO_CD_UF` ON `TB_PESSOA_ENDERECO` (`CD_UF` ASC) ;

CREATE INDEX `TB_PESSOA_ENDERECO_CD_CIDADE` ON `TB_PESSOA_ENDERECO` (`CD_CIDADE` ASC) ;

CREATE INDEX `TB_PESSOA_ENDERECO_CD_CEP` ON `TB_PESSOA_ENDERECO` (`CD_CEP` ASC) ;
...
CREATE INDEX `TB_PUBLICACAO_CD_PESSOA` ON `TB_PUBLICACAO` (`CD_PESSOA` ASC) ;

CREATE INDEX `NM_PUBLICACAO` ON `TB_PUBLICACAO` (`NM_PUBLICACAO` ASC) ;
...
CREATE INDEX `TB_PUBLICACAO_ANEXO_CD_PUBLICACAO` ON `TB_PUBLICACAO_ANEXO` (`CD_PUBLICACAO` ASC) ;

CREATE INDEX `TB_PUBLICACAO_ANEXO_CD_OBJETO` ON `TB_PUBLICACAO_ANEXO` (`CD_OBJETO` ASC) ;
...
CREATE INDEX `TB_COMENTARIO_PUBLICACAO_CD_COMENTARIO` ON `TB_COMENTARIO_PUBLICACAO` (`CD_COMENTARIO` ASC) ;

CREATE INDEX `TB_COMENTARIO_PUBLICACAO_CD_PUBLICACAO` ON `TB_COMENTARIO_PUBLICACAO` (`CD_PUBLICACAO` ASC) ;
...
CREATE INDEX `TB_COLEGA_CD_PESSOA` ON `TB_COLEGA` (`CD_PESSOA` ASC) ;

CREATE INDEX `TB_COLEGA_CD_PESSOA_COLEGA` ON `TB_COLEGA` (`CD_PESSOA_COLEGA` ASC) ;
...
CREATE INDEX `IX_SALA_CD_PESSOA` ON `TB_SALA` (`CD_PESSOA` ASC) ;

CREATE INDEX `IX_SALA_CD_ESPECIALIDADE` ON `TB_SALA` (`CD_ESPECIALIDADE` ASC) ;

CREATE INDEX `IX_SALA_DT_INCLUSAO` ON `TB_SALA` (`DT_INCLUSAO` ASC) ;

CREATE INDEX `IX_SALA_DT_INICIO` ON `TB_SALA` (`DT_INICIO` ASC) ;
...
CREATE INDEX `TB_SALA_PESSOAS_CD_PESSOA` ON `TB_SALA_PESSOAS` (`CD_PESSOA` ASC) ;

CREATE INDEX `TB_SALA_PESSOAS_CD_SALA` ON `TB_SALA_PESSOAS` (`CD_SALA` ASC) ;
...
CREATE INDEX `TB_SALA_CONVITE_CD_SALA` ON `TB_SALA_CONVITE` (`CD_SALA` ASC) ;

CREATE INDEX `TB_SALA_CONVITE_CD_PESSOA` ON `TB_SALA_CONVITE` (`CD_PESSOA` ASC) ;
