...
--
-- Host: localhost
-- Generation Time: Mar 29, 2011 at 05:27 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Pessoas do círculo' AUTO_INCREMENT=8 ;
...
DROP TABLE IF EXISTS `tb_convite`;
...
DROP TABLE IF EXISTS `tb_convite_pessoa`;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Pessoas do sistema. Cada pessoa será única dentro da exist' AUTO_INCREMENT=4 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Salas de discussão' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Participantes da sala' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabela do usuários do sistema, este será a forma de entrad' AUTO_INCREMENT=4 ;
