    ...
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
                    <h2>Consumo de <?php echo $INI['system']['couponname']; ?></h2>
				</div>
                <div class="sect">
					<table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
					<tr><th width="100">Codigo</th><th width="440">Item</th><th width="180">Usuario</th><th width="140">Data</th></tr>
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td nowrap><?php echo date('d-m-Y',$one['consume_time']); ?></td>
					</tr>
					<?php }}?>
