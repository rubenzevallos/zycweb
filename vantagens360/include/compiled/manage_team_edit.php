            ...
            <div class="box-content">
				...
				<form id="-user-form" method="post" action="/manage/team/edit.php?id=<?php echo $team['id']; ?>" enctype="multipart/form-data" class="validator">
					...
					<div class="field">
						...
						<div style="float:left;"><textarea cols="45" rows="5" name="summary" id="team-create-summary" class="xheditor-simple" datatype="require" require="true"><?php echo htmlspecialchars($team['summary']); ?></textarea></div>
