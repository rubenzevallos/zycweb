    ...
    <div id="content" class="login-box">
        <div class="box">
            ...
            <div class="box-content">
                <div class="head"><h2>Login</h2><span>&nbsp;ou&nbsp;<a href="/account/signup.php">Registre-se </a></span></div>
                <div class="sect">
                    <form id="login-user-form" method="post" action="/account/login.php" class="validator">
                        ...
                        <div class="field password">
                            ...
                            <span class="lostpassword"><a href="/account/repass.php">Perdeu sua senha?</a></span>
                        </div>
    ...
    <div id="sidebar">
        <div class="sbox">
            ...
            <div class="sbox-content">
                <div class="side-tip">
                    <h2>Ainda n&atilde;o tem uma&nbsp;<?php echo $INI['system']['abbreviation']; ?>&nbsp;conta?</h2>
                    <p><a href="/account/signup.php">Cadastre-se </a>&nbsp;rapidamente&nbsp;agora!</p>
                </div>
            </div>
