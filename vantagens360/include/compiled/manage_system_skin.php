	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head"><h2>Temas</h2></div>
                <div class="sect">
                    <form method="post">
                        <div class="field">
							...
							<span class="hint">Template esta em [<?php echo DIR_ROOT; ?>/template] , somente o template padrão suporta vários temas.</span>
                        </div>
                        <div class="field">
                            <label>Temas</label>
							...
							<span class="hint">Tema localizado em [<?php echo WWW_ROOT; ?>/static/theme] , somente o template padrão suporta vários temas.</span>
                        </div>
                        <div class="act">
