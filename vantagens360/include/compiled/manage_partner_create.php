	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head"><h2>Cadastrar novo parceiro</h2></div>
                <div class="sect">
                    <form id="login-user-form" method="post" action="/manage/partner/create.php" class="validator">
						...
						<div class="wholetip clear"><h3>2. Informações básicas</h3></div>
                        <div class="field">
                            <label>None</label>
                        ...
                        <div class="act">
                            <input type="submit" value="Cadastrar" name="commit" id="partner-submit" class="formbutton"/>
                        </div>
                    </form>
                </div>
            </div>
