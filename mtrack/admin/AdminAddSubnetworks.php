...
if($task == "doadd") {
  ...
  // NO ERROR, INSERT SUBNETWORK
    ...
    $database->database_query("INSERT INTO phps_subnets (subnet_name, subnet_field1_qual, subnet_field1_value, subnet_field2_qual, subnet_field2_value) VALUES ('$subnet_name', '$subnet_field1_qual', '$subnet_field1_value', '$subnet_field2_qual', '$subnet_field2_value')");
