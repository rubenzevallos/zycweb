...
<div class="row">
    <div class="block">
        ...
        <div class="block-in">
            <p><label><textarea>{$setting_banned_ips}</textarea></label></p>
        </div>
...
<div class="row">
    <div class="block">
        ...
        <div class="block-in">
            <p><label><textarea>{$setting_banned_emails}</textarea></label></p>
        </div>
        <div class="block-b">&nbsp;</div>
    </div>
    <p>{$Admin295}</p>
...
<div class="row">
    <div class="block">
        ...
        <div class="block-in">
            <p><label><textarea>{$setting_banned_usernames}</textarea></label></p>
        </div>
        <div class="block-b">&nbsp;</div>
    </div>
    <p>{$Admin297}</p>
...
<div class="row">
    <div class="block">
        ...
        <div class="block-in">
            <p><label><textarea>{$setting_banned_words}</textarea></label></p>
        </div>
        <div class="block-b">&nbsp;</div>
    </div>
    <p>{$Admin299}</p>
