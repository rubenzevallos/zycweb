...
<table cellpadding='0' cellspacing='0' width='100%' style="color:#666666;">
    <tr><td class='header'>{$Admin124}</td></tr>
                ...
                <tr>
                    <td id='bannerborder' class='bannerborder{if $ad_html != ""}2{/if}' align='center'>
                        ...
                        <div id='banner_options' style='{if $ad_html != ""}display: none;{/if}'>
                            <h3><b><a href="javascript:hidediv('banner_options');showdiv('banner_upload');">{$Admin126}</a> &nbsp;&nbsp;{$Admin127}&nbsp;&nbsp; <a href="javascript:hidediv('banner_options');showdiv('banner_html');">{$Admin128}</a></b></h3>
                        </div>

                        <div id='banner_upload' style='display: none;'>
                            <b>{$Admin129}</b>
                            <form action='AdminAdsAdd.php' enctype='multipart/form-data' method='post' id='uploadform' name='uploadform' target='uploadframe'>
                                <table cellpadding='0' cellspacing='0' align='center'>
                                    <tr>
                                        <td class='form1'>{$Admin130}</td>
                                        <td class='form2'><input type='file' name='file1' size='40' id='bannersrc' class="input-border"></td>
                                    </tr>
                                    <tr>
                                        <td class='form1'>{$Admin131}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class='form2'>
                                            <div id='banner_upload_submit'>
                                                [ <a href="javascript:uploadbanner()">{$Admin132}</a> ] &nbsp;
                                                [ <a href="javascript:hidediv('banner_upload');showdiv('banner_options');">{$Admin133}</a> ]
                                            </div>
                        ...
                        <div id='banner_html' style='display: none;'>
                            ...
                            <div style='margin-top: 5px;'>
                                [ <a href="javascript:savebanner();">{$Admin135}</a> ] &nbsp;
                                [ <a href="javascript:hidediv('banner_html');showdiv('banner_options');">{$Admin133}</a> ]
                            </div>
                        </div>

                        <div id='banner_preview_html' style='display: none;'>
                            <div style='margin-bottom: 5px;'><b>{$Admin137}</b></div>
                            <div id='banner_html_content'></div>
                            <div style='margin-top: 5px;'>
                                [ <a href="javascript:savebanner2();">{$Admin136}</a> ] &nbsp;
                                [ <a href="javascript:hidediv('banner_preview_html');showdiv('banner_html');">{$Admin133}</a> ]
                            </div>
                        </div>
                        ...
                        <div id='banner_preview_upload' style='display: none;'>
                            ...
                            <div style='margin-top: 5px;'>
                                [ <a href="javascript:uploadbanner3();">{$Admin136}</a> ] &nbsp;
                                [ <a href="javascript:uploadbanner3_cancel();">{$Admin133}</a> ]
                            </div>
                            <form action='AdminAdsAdd.php' method='post' id='cancelform' name='cancelform' target='uploadframe'>
                        ...
                        <div id='banner_final_title' style='{if $ad_html == ""}display: none;{/if} padding-bottom: 3px;'><b>{$Admin137}</b></div>
                        <div id='banner_final' style='{if $ad_html == ""}display: none;{/if}'>{$ad_html}</div>
                        <div id='banner_final_startover' style='{if $ad_html == ""}display: none;{/if} padding-top: 3px;'><a href="javascript:startover()">{$Admin138}</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:backtohtml()">{$Admin178}</a></div>
                        ...
                        <script language='Javascript'>
                            ...
                            function uploadbanner() {
                                ...
                                if(bannersrc == "") {
                                    alert('{/literal}{$Admin139}{literal}');
                                } else {
                            ...
                            function savebanner() {
                                ...
                                if(bannerhtml == "") {
                                    alert('{/literal}{$Admin141}{literal}');
                                } else {
                                    hidediv('banner_html');
...
<form action='AdminAdsAdd.php' method='post'>
    ...
    <table cellpadding='0' cellspacing='0' width='100%' style="color:#666666;">
        <tr><td class='header'>{$Admin142}</td></tr>
        <tr><td class='setting1'>
                {$Admin143}
                <br><br>
                <b>{$Admin144} {$nowdate}</b>
        </td></tr>
        <tr><td class='setting2'>
                <table cellpadding='0' cellspacing='4' style="color:#666666;">
                    <tr>
                        <td class='form1'>{$Admin145}</td>
                        <td class='form2'><input type='text' class="input-border" name='ad_name' size='64' maxlength='250' value='{$ad_name}'></td>
                    </tr>
                    <tr>
                        <td class='form1'>{$Admin146}</td>
                        <td class='form2'>
                            <select class="input-border" name='ad_date_start_month'>
                                <option></option>
                                <option{if $ad_date_start_month == "$Admin147"} selected='selected'{/if}>{$Admin147}</option>
                                <option{if $ad_date_start_month == "$Admin148"} selected='selected'{/if}>{$Admin148}</option>
                                <option{if $ad_date_start_month == "$Admin149"} selected='selected'{/if}>{$Admin149}</option>
                                <option{if $ad_date_start_month == "$Admin150"} selected='selected'{/if}>{$Admin150}</option>
                                <option{if $ad_date_start_month == "$Admin151"} selected='selected'{/if}>{$Admin151}</option>
                                <option{if $ad_date_start_month == "$Admin152"} selected='selected'{/if}>{$Admin152}</option>
                                <option{if $ad_date_start_month == "$Admin153"} selected='selected'{/if}>{$Admin153}</option>
                                <option{if $ad_date_start_month == "$Admin154"} selected='selected'{/if}>{$Admin154}</option>
                                <option{if $ad_date_start_month == "$Admin155"} selected='selected'{/if}>{$Admin155}</option>
                                <option{if $ad_date_start_month == "$Admin156"} selected='selected'{/if}>{$Admin156}</option>
                                <option{if $ad_date_start_month == "$Admin157"} selected='selected'{/if}>{$Admin157}</option>
                                <option{if $ad_date_start_month == "$Admin158"} selected='selected'{/if}>{$Admin158}</option>
                            </select>
                            ...
                            <select class="input-border" name='ad_date_start_ampm'>
                                <option></option>
                                <option{if $ad_date_start_ampm == "$Admin159"} selected='selected'{/if}>{$Admin159}</option>
                                <option{if $ad_date_start_ampm == "$Admin160"} selected='selected'{/if}>{$Admin160}</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td class='form1'>{$Admin161}</td>
                        <td class='form2'>
                            ...
                            <table cellpadding='0' cellspacing='0' style="color:#666666;">
                                <tr>
                                    ...
                                    <td><label for='timelimit0'>{$Admin162}</label></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><label for='timelimit1'>{$Admin163}</label></td>
                                </tr>
                            </table>
                            ...
                            <div style='margin-top: 7px; margin-bottom: 2px;{if $ad_date_end_options != 1} display: none;{/if}' id='enddate'>
                                <select class="input-border" name='ad_date_end_month'>
                                    <option></option>
                                    <option{if $ad_date_end_month == "$Admin147"} selected='selected'{/if}>{$Admin147}</option>
                                    <option{if $ad_date_end_month == "$Admin148"} selected='selected'{/if}>{$Admin148}</option>
                                    <option{if $ad_date_end_month == "$Admin149"} selected='selected'{/if}>{$Admin149}</option>
                                    <option{if $ad_date_end_month == "$Admin150"} selected='selected'{/if}>{$Admin150}</option>
                                    <option{if $ad_date_end_month == "$Admin160"} selected='selected'{/if}>{$Admin151}</option>
                                    <option{if $ad_date_end_month == "$Admin161"} selected='selected'{/if}>{$Admin152}</option>
                                    <option{if $ad_date_end_month == "$Admin162"} selected='selected'{/if}>{$Admin153}</option>
                                    <option{if $ad_date_end_month == "$Admin163"} selected='selected'{/if}>{$Admin154}</option>
                                    <option{if $ad_date_end_month == "$Admin164"} selected='selected'{/if}>{$Admin155}</option>
                                    <option{if $ad_date_end_month == "$Admin165"} selected='selected'{/if}>{$Admin156}</option>
                                    <option{if $ad_date_end_month == "$Admin166"} selected='selected'{/if}>{$Admin157}</option>
                                    <option{if $ad_date_end_month == "$Admin167"} selected='selected'{/if}>{$Admin158}</option>
                                </select>
                                ...
                                <select class="input-border" name='ad_date_end_ampm'>
                                    <option></option>
                                    <option{if $ad_date_end_ampm == "$Admin159"} selected='selected'{/if}>{$Admin159}</option>
                                    <option{if $ad_date_end_ampm == "$Admin160"} selected='selected'{/if}>{$Admin160}</option>
                                </select>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class='form1'>{$Admin164}</td>
                        <td class='form2'>
                            <table cellpadding='0' cellspacing='0' style="color:#666666;">
                                <tr>
                                    ...
                                    <td><input type='checkbox' id='ad_limit_views' name='ad_limit_views_unlimited' value='1' class='checkbox'{if $ad_limit_views_unlimited != "unchecked"} checked='checked'{/if} onClick="togglefield('views_field', this)"> <label for='ad_limit_views'>{$Admin165}</label></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td class='form1'>{$Admin166}</td>
                        <td class='form2'>
                            <table cellpadding='0' cellspacing='0' style="color:#666666;">
                                <tr>
                                    ...
                                    <td><input type='checkbox' id='ad_limit_clicks' name='ad_limit_clicks_unlimited' value='1' class='checkbox'{if $ad_limit_clicks_unlimited != "unchecked" OR $ad_limit_clicks_unlimited == ""} checked='checked'{/if} onClick="togglefield('clicks_field', this)"> <label for='ad_limit_clicks'>{$Admin165}</label></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td class='form1'>{$Admin167}</td>
                        <td class='form2'>
                            <table cellpadding='0' cellspacing='0' style="color:#666666;">
                                <tr>
                                    ...
                                    <td><input type='checkbox' id='ad_limit_minctr' name='ad_limit_ctr_unlimited' value='1' class='checkbox'{if $ad_limit_ctr_unlimited != "unchecked" OR $ad_limit_clicks_unlimited == ""} checked='checked'{/if} onClick="togglefield('minctr_field', this)"> <label for='ad_limit_minctr'>{$Admin165}</label></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    <table cellpadding='0' cellspacing='0' width='100%' style="color:#666666; border-spacing:0px!important;">
        <tr><td class='header'>{$Admin168}</td></tr>
        <tr><td class='setting1'>
                {$Admin169}
        </td></tr>
        <tr><td class='setting2'>
    ...
    <table cellpadding='0' cellspacing='7' width='100%' style="color:#666666;">
        <tr><td class='header'>{$Admin171}</td></tr>
        <tr><td class='setting1'>
                {$Admin172}
        </td></tr>
        <tr><td class='setting2'>
                <table cellpadding='0' cellspacing='4' align='center' style="color:#666666;">
                    <tr>
                        <td><b>User Levels</b></td>
                        <td style='padding-left: 10px;'><b>{$Admin173}</b></td>
                    </tr>
                    <tr>
                        <td>
                            <select size='{$options_to_show}' class="input-border" name='ad_levels[]' multiple='multiple' style='width: 335px;'>
                                {section name=level_loop loop=$levels}
                                <option value='{$levels[level_loop].level_id}'{if $levels[level_loop].level_selected == 1} selected='selected'{/if}>{$levels[level_loop].level_name|truncate:75:"...":true}{if $levels[level_loop].level_default == 1} {$Admin174}{/if}</option>
                                {/section}
                            </select>
                        </td>
                        <td style='padding-left: 10px;'>
                            <select size='{$options_to_show}' class="input-border" name='ad_subnets[]' multiple='multiple' style='width: 335px;'>
        ...
        <tr><td class='setting2'>
                <table cellpadding='0' cellspacing='2' style="color:#666666;">
                    <tr>
                        ...
                        <td><label for='ad_public'>&nbsp;{$Admin175}</label></td>
                    </tr>
                </table>
        </td></tr>
    </table>
    ...
    <tr>
    <td>
    <label class="button"><input type='submit' value='{$Admin176}'/></label>
    <input type='hidden' name='task' value='dosave'>
</form>
</td>
<td>
    <form action='AdminAds.php' method='post'>
        <label class="button"><input type='submit' value='{$Admin177}'/></label>
    </form>
</td>
</tr>
</table>
