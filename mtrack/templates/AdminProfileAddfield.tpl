...
<option value=''></option>
<option value='1'{if $field_type == 1} SELECTED{/if}>{$Admin587}</option>
<option value='2'{if $field_type == 2} SELECTED{/if}>{$Admin588}</option>
<option value='3'{if $field_type == 3} SELECTED{/if}>{$Admin589}</option>
<option value='4'{if $field_type == 4} SELECTED{/if}>{$Admin560}</option>
